...
class RechargeOrderService
{
    ...
    public function payload(RechargeOrder $order, ?array $config = null): array
    {
        ...
        return [
            ...
            'epayTradeNo' => (string) ($order->epay_trade_no ?? ''),
            'sub2BalanceBefore' => $order->sub2_balance_before === null ? null : $this->money2($order->sub2_balance_before),
            'sub2BalanceAfter' => $order->sub2_balance_after === null ? null : $this->money2($order->sub2_balance_after),
